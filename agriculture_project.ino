...
#define FIREBASE_HOST "smart-irrigation-system-ae038-default-rtdb.firebaseio.com"           // Your Firebase Project URL 
#define FIREBASE_AUTH "LsLt3GlRA9buZURmF8NIdu9xZCX7JF0MDnFQ29h1"         // Your Firebase Database Secret
